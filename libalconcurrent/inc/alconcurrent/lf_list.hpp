...
private:
	old_lockfree_list( const old_lockfree_list& )            = delete;
	old_lockfree_list( old_lockfree_list&& )                 = delete;
	old_lockfree_list& operator=( const old_lockfree_list& ) = delete;
	old_lockfree_list& operator=( old_lockfree_list&& )      = delete;
