...
TEST( AtomicSharedPtr_Class, CanConstruct )
{
	...
	// Act
	alpha::concurrent::internal::atomic_shared_ptr<int> sut;
...
TEST( AtomicSharedPtr_Class, CanConstructWithPointer )
{
	...
	// Act
	alpha::concurrent::internal::atomic_shared_ptr<int> sut( p );
...
TEST( AtomicSharedPtr_Class, CanConstructWithPointerAndDeleter )
{
	...
	// Act
	alpha::concurrent::internal::atomic_shared_ptr<int> sut( p, deleter );
...
TEST( AtomicSharedPtr_Class, CanConstructWithUniquePtr )
{
	...
	// Act
	alpha::concurrent::internal::atomic_shared_ptr<int> sut( std::move( up ) );
...
{
	// Arrange
	alpha::concurrent::internal::atomic_shared_ptr<int> sut1;

	// Act
	alpha::concurrent::internal::atomic_shared_ptr<int> sut2( sut1 );
...
TEST( AtomicSharedPtr_Class, CanCopyConstructFromValid )
{
	// Arrange
	int*                                                p = new int;
	alpha::concurrent::internal::atomic_shared_ptr<int> sut1( p );
...
TEST( AtomicSharedPtr_Class, CanMoveConstructFromEmpty )
{
	...
	// Act
	alpha::concurrent::internal::atomic_shared_ptr<int> sut2( std::move( sut1 ) );
...
TEST( AtomicSharedPtr_Class, Valid_CanCopyStoreFromValidSharedPtr )
{
	...
	int*                                                p1 = new int;
	int*                                                p2 = new int;
	alpha::concurrent::internal::atomic_shared_ptr<int> sut( p1 );
